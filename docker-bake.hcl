  ...
  result = distro == "static" ? pkgPlatforms(pkg) : setsubtract(
    setintersection(
      lookup({
        ...
        debian13 = ["linux/loong64"]
        debian14 = ["linux/loong64"]
...
target "_pkg-containerd" {
  args = {
    ...
    GO_VERSION = GO_VERSION != null && GO_VERSION != "" ? GO_VERSION : "1.26.2" # https://github.com/containerd/containerd/blob/release/2.3/.github/workflows/release/Dockerfile
    GO_IMAGE_VARIANT = GO_IMAGE_VARIANT != null && GO_IMAGE_VARIANT != "" ? GO_IMAGE_VARIANT : "bookworm"
    PKG_DEB_EPOCH = PKG_DEB_EPOCH != null && PKG_DEB_EPOCH != "" ? PKG_DEB_EPOCH : ""
...
target "_pkg-docker-cli" {
  args = {
    ...
    PKG_REF = PKG_REF != null && PKG_REF != "" ? PKG_REF : "master"
    GO_VERSION = GO_VERSION != null && GO_VERSION != "" ? GO_VERSION : "1.26.2" # https://github.com/docker/cli/blob/master/Dockerfile
    GO_IMAGE_VARIANT = GO_IMAGE_VARIANT != null && GO_IMAGE_VARIANT != "" ? GO_IMAGE_VARIANT : "bookworm"
...
target "_pkg-docker-engine" {
  args = {
    ...
    PKG_REF = PKG_REF != null && PKG_REF != "" ? PKG_REF : "master"
    GO_VERSION = GO_VERSION != null && GO_VERSION != "" ? GO_VERSION : "1.26.2" # https://github.com/moby/moby/blob/master/Dockerfile
    GO_IMAGE_VARIANT = GO_IMAGE_VARIANT != null && GO_IMAGE_VARIANT != "" ? GO_IMAGE_VARIANT : "bookworm"
    PKG_DEB_EPOCH = PKG_DEB_EPOCH != null && PKG_DEB_EPOCH != "" ? PKG_DEB_EPOCH : "5"
    PKG_REMOTE_DOCKERFILE = "Dockerfile"
  }
